                ...
                {[
                  {
                    ...
                    label: 'Email',
                    value: (
                      <a href="mailto:shashaank.shashank@gmail.com" className="text-gray-700 dark:text-gray-300 hover:text-teal-500 transition">
                  ...
                  },
                  {
                    ...
                    label: 'Phone',
                    value: (
                      <a href="tel:+918499883581" className="text-gray-700 dark:text-gray-300 hover:text-teal-500 transition">
                        +91-8499883581
                      </a>
                    )
                  },
                  ...
                  <div key={idx} className="flex items-start">
                    <div className="bg-gray-100 dark:bg-gray-700 p-3 rounded-full mr-4">{item.icon}</div>
                    <div>
              ...
              <div className="mt-10 text-center">
                ...
                <div className="space-y-4">
                  <a
                    ...
                    className="inline-flex items-center px-6 py-3 bg-teal-400 hover:bg-teal-500 text-white font-medium rounded-md transition-shadow shadow"
                  >
            ...
            <div className="bg-gray-50 dark:bg-gray-800 rounded-2xl shadow-lg p-6 md:p-8">
              ...
              <form onSubmit={handleSubmit}>
                  ...
                  {['name', 'email'].map((field, i) => (
                    <div key={i}>
                      ...
                      <input
                        ...
                        required
                        className="w-full px-4 py-2 bg-white dark:bg-gray-900 border border-gray-300 dark:border-gray-700 rounded-md focus:outline-none focus:ring-2 focus:ring-teal-400 transition text-gray-900 dark:text-white"
                      />
                    </div>
                  ))}
                </div>
                ...
                <button
                  ...
                  className={`w-full flex justify-center items-center px-6 py-3 bg-teal-400 hover:bg-teal-500 text-white font-medium rounded-md transition ${
