  ...
  const projects = [
    {
      ...
      description:
        "A comprehensive quality management system designed to monitor operational and regulatory Quality KPIs at the Serum Institute of India.",
      objective:
        "Design a scalable data warehouse to consolidate data from multiple systems, ensuring actionable insights and compliance reporting through interactive dashboards.",
      contributions: [
    ...
    },
    {
      ...
      description:
        "A comprehensive data quality and reporting platform designed to ingest data from various sources, perform rigorous data quality checks, and store the results in a PostgreSQL database.",
      objective:
        "Deliver high-quality, procedure-driven reports and dashboards within the application's executive interface, providing both real-time insights and end-of-day statistics on data trust scores across different levels.",
      contributions: [
    ...
    },
    {
      ...
      description:
        "A healthcare system focused on providing emergency health services through multiple modules, primarily the Emergency Response Officer (ERO) module.",
      objective:
        "Handle emergency calls and dispatch ambulances to incident locations efficiently while maintaining comprehensive data management.",
      contributions: [
    ...
    <section id="projects" className="py-20 bg-white dark:bg-gray-900">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <div className="h-1 w-20 bg-teal-400 dark:bg-teal-300 mx-auto mb-6 rounded"></div>
          <p className="text-gray-700 dark:text-gray-300 max-w-2xl mx-auto">
            Explore my key projects showcasing database development, data
            engineering, and visualization expertise.
          </p>
        </div>
            ...
            <button
              ...
              className={`px-4 py-2 rounded-full text-sm font-medium transition-all duration-300 ${
                activeFilter === filter.id
                  ? "bg-teal-400 dark:bg-teal-300 text-white"
          ...
          {filteredProjects.map((project) => (
            ...
            >
              <div className="relative">
                <div className="h-48 bg-gradient-to-r from-gray-900 to-teal-400 dark:from-gray-900 dark:to-teal-300 flex items-center justify-center">
                  <h3 className="text-xl font-bold text-white px-4 text-center">
                    {project.title}
                  </h3>
                </div>
                <div className="absolute bottom-0 left-0 bg-teal-400 dark:bg-teal-300 text-white text-xs px-3 py-1 rounded-tr-lg">
                  {project.client}
                </div>
              </div>
              ...
              <div className="p-6">
                ...
                <div className="mt-4 flex flex-wrap gap-2 mb-4">
                  {project.technologies.map((tech, idx) => (
                    <span
                      key={idx}
                      className="text-xs px-2 py-1 bg-gray-50 dark:bg-gray-700 text-teal-400 dark:text-teal-300 rounded-full"
                    >
                      {tech}
                    </span>
                  ))}
                ...
                <button
                  ...
                  className="text-teal-400 dark:text-teal-300 font-medium hover:underline focus:outline-none"
                >
